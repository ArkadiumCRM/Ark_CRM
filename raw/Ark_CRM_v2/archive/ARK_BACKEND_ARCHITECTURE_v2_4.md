...
### Reminders
```
GET    /api/v1/reminders                      ← Meine Reminders (gefiltert: überfällig/heute/bald)
POST   /api/v1/reminders                      ← Neuen Reminder erstellen
GET    /api/v1/reminders/:id
PATCH  /api/v1/reminders/:id                  ← Datum/Notiz ändern
POST   /api/v1/reminders/:id/complete         ← Als erledigt markieren
POST   /api/v1/reminders/:id/snooze           ← +1h/+1d/+1w
```
...
```
  Produktiv-Konfiguration:
    ...
    Shared Account: (zentraler Sync-Account, Phase 1)
  ...
  Shared Mailbox-Ansatz (Phase 1):
    - Zentraler Account einmalig authorisiert
    - Alle CRM-relevanten Mails über diesen zentralen Account
    - Kein OAuth-Onboarding pro Mitarbeiter nötig
    - Phase 2: individuelle Tokens pro Mitarbeiter möglich
...
OUTLOOK_SHARED_ACCOUNT=...      # Zentraler Sync-Account (Phase 1)
