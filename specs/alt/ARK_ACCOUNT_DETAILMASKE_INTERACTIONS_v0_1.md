# ARK CRM — Account-Detailmaske Interactions Spec v0.1

**Stand:** 08.04.2026
**Status:** Arbeitsdokument — Spec-in-Progress, wird fortgeführt
...
| 8 | Prozesse | fact_process_core (offen) |
| 9 | History | fact_history (offen) |
| 10 | Dokumente | fact_documents (offen) |
| 11 | Reminders | fact_reminders (offen) |
| (bedingt) | Firmengruppe | Nur sichtbar wenn `account_group_id IS NOT NULL` |

11 fixe Tabs + 1 bedingt.
...
## TEIL 10: SCHEMA-DELTA-NOTIZ (für Audit-Runde nach Fertigstellung)
